//! Nevis IAM authentication provider for Construct.
//!
...
//! roles to Construct tool permissions via [`super::iam_policy::IamPolicy`].
...
mod tests {
    ...
    fn nevis_identity_serde_roundtrip() {
        ...
        assert_eq!(parsed.user_id, "construct_user");
