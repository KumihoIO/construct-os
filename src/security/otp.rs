...
const OTP_ISSUER: &str = "Construct";
...
impl OtpValidator {
    pub fn from_config(
        ...
        let secret_path = secret_file_path(construct_dir);
...
pub fn secret_file_path(construct_dir: &Path) -> PathBuf {
    construct_dir.join(OTP_SECRET_FILE)
}
