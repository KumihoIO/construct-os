    ...
    pub fn with_defaults() -> Self {
        Self {
            sections: vec![
                ...
                Box::new(IdentitySection), // Persona first (SOUL.md) — voice/character
                Box::new(OperatorIdentitySection), // Orchestration capabilities (role)
                Box::new(KumihoBootstrapSection), // Kumiho memory instructions
