<p align="center">
  <img src="https://raw.githubusercontent.com/KumihoIO/Construct/main/docs/assets/construct-banner.png" alt="Construct" width="600" />
</p>
...
<p align="center">
  <a href="https://github.com/KumihoIO/Construct/actions/workflows/ci-run.yml"><img src="https://img.shields.io/github/actions/workflow/status/KumihoIO/Construct/ci-run.yml?branch=main&label=build" alt="Build Status" /></a>
  <a href="LICENSE-APACHE"><img src="https://img.shields.io/badge/license-MIT%20OR%20Apache%202.0-blue.svg" alt="License: MIT OR Apache-2.0" /></a>
  <a href="https://www.rust-lang.org"><img src="https://img.shields.io/badge/rust-edition%202024-orange?logo=rust" alt="Rust Edition 2024" /></a>
  <a href="https://github.com/KumihoIO/Construct/releases/latest"><img src="https://img.shields.io/badge/version-v2026.4.21-blue" alt="Version v2026.4.21" /></a>
  <a href="https://github.com/KumihoIO/Construct/graphs/contributors"><img src="https://img.shields.io/github/contributors/KumihoIO/Construct?color=green" alt="Contributors" /></a>
...
| 날짜 (UTC) | 수준 | 공지 | 조치 |
| ---------- | ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-02-19 | _치명적_ | 우리는 `openagen/construct`, `construct.org` 또는 `construct.net`과 **관련이 없습니다**. `construct.org`과 `construct.net` 도메인은 현재 `openagen/construct` 포크를 가리키고 있으며, 해당 도메인/저장소는 우리의 공식 웹사이트/프로젝트를 사칭하고 있습니다. | 해당 소스의 정보, 바이너리, 모금, 공지를 신뢰하지 마세요. [이 저장소](https://github.com/KumihoIO/Construct)와 검증된 소셜 계정만 사용하세요. |
| 2026-02-21 | _중요_ | 공식 웹사이트가 이제 온라인입니다: [kumiho.io](https://kumiho.io). 기다려주셔서 감사합니다. 사칭 시도가 여전히 감지되고 있으므로, 공식 채널을 통해 게시되지 않은 Construct 이름의 투자나 모금 활동에 참여하지 **마세요**. | [이 저장소](https://github.com/KumihoIO/Construct)를 유일한 진실의 원천으로 사용하세요. [X (@KumihoHQ)](https://x.com/KumihoHQ), [Facebook (그룹)](https://x.com/KumihoHQ), [Reddit (r/KumihoIO)](https://www.reddit.com/r/KumihoIO)을 팔로우하여 공식 업데이트를 받으세요. |
...
```bash
curl -LsSf https://raw.githubusercontent.com/KumihoIO/Construct/main/install.sh | bash
```
...
최신 에셋 다운로드:
<https://github.com/KumihoIO/Construct/releases/latest>
...
Construct가 처음이신가요? [`good first issue`](https://github.com/KumihoIO/Construct/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22) 레이블이 붙은 이슈를 찾아보세요 — 시작하는 방법은 [기여 가이드](CONTRIBUTING.md#first-time-contributors)를 참조하세요. AI/vibe-coded PR도 환영합니다! 🤖
...
사칭이나 상표 오용을 발견하면 [이슈를 열어](https://github.com/KumihoIO/Construct/issues) 신고해 주세요.
...
<a href="https://github.com/KumihoIO/Construct/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=KumihoIO/Construct" alt="Construct contributors" />
</a>
...
<p align="center">
  <a href="https://www.star-history.com/#KumihoIO/Construct&type=date&legend=top-left">
    <picture>
     <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=KumihoIO/Construct&type=date&theme=dark&legend=top-left" />
     <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=KumihoIO/Construct&type=date&legend=top-left" />
     <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=KumihoIO/Construct&type=date&legend=top-left" />
    </picture>
  </a>
</p>
