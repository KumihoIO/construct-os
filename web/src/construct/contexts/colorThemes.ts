/**
 * Color theme palettes for the Construct dashboard.
 *
...
function lightBase(
  ...
  return {
    ...
    '--pc-text-muted': textMuted,
    '--pc-text-faint': textFaint,
    /* Light-theme scrollbars: use the darker `textMuted`/`textSecondary` for
       visible contrast against light surfaces (textFaint is too washed-out). */
    '--pc-scrollbar-thumb': textMuted,
    '--pc-scrollbar-track': 'transparent',
    '--pc-scrollbar-thumb-hover': textSecondary,
