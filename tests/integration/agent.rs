...
//!
//! Ref: https://github.com/KumihoIO/construct-os/issues/618 (item 6)
...
use construct::providers::traits::ChatMessage;
use construct::providers::{ChatResponse, ConversationMessage, ToolCall};
...
async fn e2e_multi_turn_with_memory_enrichment() {
    ...
    assert!(req1_user.content.contains("project: construct"));
