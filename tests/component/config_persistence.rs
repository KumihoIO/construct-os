...
// Tests for embedding_provider and vector/keyword weights removed —
// those fields no longer exist on MemoryConfig (Kumiho MCP backend).
...
fn config_toml_roundtrip_preserves_memory_config() {
    ...
    config.memory.hygiene_enabled = false;
