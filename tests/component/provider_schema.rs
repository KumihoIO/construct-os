...
use construct::providers::compatible::AuthStyle;
use construct::providers::traits::{ChatMessage, ChatResponse, ToolCall};
...
fn provider_construction_with_different_names() {
    use construct::providers::compatible::OpenAiCompatibleProvider;
