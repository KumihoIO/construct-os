# Hub Tài liệu Construct (Tiếng Việt)

Đây là trang chủ tiếng Việt của hệ thống tài liệu.

> Runtime Rust lõi của Construct là fork của [ZeroClaw](https://github.com/zeroclaw-labs/zeroclaw); xem [`NOTICE`](../../../NOTICE) để biết attribution đầy đủ.

Đồng bộ lần cuối: **April 21, 2026**.
...
Hub bản địa hóa: [简体中文](../zh-CN/README.md).
