...
class TestLoadSkill:
    def test_load_known_skill(self, skills_dir):
        with patch("operator.skill_loader._SKILLS_DIR", skills_dir), \
             patch("operator.skill_loader._SKILL_FILES", {"operator-orchestrator": "operator-orchestrator.md"}):
    ...
    def test_cache_hit(self, skills_dir):
        with patch("operator.skill_loader._SKILLS_DIR", skills_dir), \
             patch("operator.skill_loader._SKILL_FILES", {"operator-loop": "operator-loop.md"}):
    ...
    def test_direct_file_lookup(self, skills_dir):
        ...
        with patch("operator.skill_loader._SKILLS_DIR", skills_dir), \
             patch("operator.skill_loader._SKILL_FILES", {}):
    ...
    def test_missing_file_returns_none(self, skills_dir):
        with patch("operator.skill_loader._SKILLS_DIR", skills_dir), \
             patch("operator.skill_loader._SKILL_FILES", {"missing": "missing.md"}):
...
class TestListSkills:
    ...
    def test_empty_dir(self, tmp_path):
        ...
        with patch("operator.skill_loader._SKILLS_DIR", empty):
            skills = list_skills()
            assert skills == []

    def test_nonexistent_dir(self):
        with patch("operator.skill_loader._SKILLS_DIR", "/nonexistent/path"):
            skills = list_skills()
            assert skills == []
